 ...
 */
public class GetDiskFreeSpaceCommand extends HaotekCommand {
    private static final String TAG = GetDiskFreeSpaceCommand.class.getSimpleName();

    public GetDiskFreeSpaceCommand(HaotekDevice device, int CommandType) {
        super(device, CommandType);
    }

    @Override
    protected String getAction() {
//        return "?custom=1&cmd=3017";
        return "?custom=1&cmd=" + WiFiCommandDefine.GET_DISK_FREE_SPACE;
    }
