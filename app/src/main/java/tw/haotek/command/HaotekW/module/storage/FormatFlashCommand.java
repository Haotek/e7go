 ...
 */
public class FormatFlashCommand extends HaotekCommand {
    private static final String TAG = FormatFlashCommand.class.getSimpleName();
    private int mPar;

    // 0: nand 1:SD
    public FormatFlashCommand(HaotekDevice device, int CommandType, int par) {
...
//        return "?custom=1&cmd=2005&par="+mPar;
        return "?custom=1&cmd=" + WiFiCommandDefine.FORMAT + "&par=" + mPar;
    }
