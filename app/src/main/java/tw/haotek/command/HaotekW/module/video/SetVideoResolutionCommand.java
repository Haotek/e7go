 ...
 */
public class SetVideoResolutionCommand extends HaotekCommand {
    private static final String TAG = SetVideoResolutionCommand.class.getSimpleName();
    private int mPar;

    public SetVideoResolutionCommand(HaotekDevice device, int CommandType, int par) {
...
//        return "?custom=1&cmd=2002&par="+mPar;
        return "?custom=1&cmd=" + WiFiCommandDefine.MOVIE_REC_SIZE + "&par=" + mPar;
    }
