 ...
 */
public class SetDeviceDateCommand extends HaotekCommand {
    private static final String TAG = SetDeviceDateCommand.class.getSimpleName();
    private String mDate;

    public SetDeviceDateCommand(HaotekDevice device, int CommandType, String date) {
...
//        return "?custom=1&cmd=3005&str=2015-12-22";// 0:photo mode 1:movie mode 2:playback mode
        return "?custom=1&cmd=" + WiFiCommandDefine.SET_DATE + "&str=" + mDate;
    }
