 ...
 */
public class SetDeviceModeCommand extends HaotekCommand {
    private static final String TAG = SetDeviceModeCommand.class.getSimpleName();
    private int mPar;

    public SetDeviceModeCommand(HaotekDevice device, int CommandType, int par) {
...
//        return "?custom=1&cmd=3001";// 0:photo mode 1:movie mode 2:playback mode
        return "?custom=1&cmd=" + WiFiCommandDefine.SET_MODE_CHANGE + "&par=" + mPar;
    }
