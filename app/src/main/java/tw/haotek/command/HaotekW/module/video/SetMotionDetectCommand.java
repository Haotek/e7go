 ...
 */
public class SetMotionDetectCommand extends HaotekCommand {
    private static final String TAG = SetMotionDetectCommand.class.getSimpleName();
    private int mPar;

    public SetMotionDetectCommand(HaotekDevice device, int CommandType, int par) {
...
//        return "?custom=1&cmd=2006&par="+mPar;
        return "?custom=1&cmd=" + WiFiCommandDefine.MOTION_DET + "&par=" + mPar;
    }
