 ...
 */
public class GetVideoStateCommand extends HaotekCommand {
    private static final String TAG = GetVideoStateCommand.class.getSimpleName();

    public GetVideoStateCommand(HaotekDevice device, int CommandType) {
