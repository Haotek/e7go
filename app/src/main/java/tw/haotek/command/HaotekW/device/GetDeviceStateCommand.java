 ...
 */
public class GetDeviceStateCommand extends HaotekCommand {
    private static final String TAG = GetDeviceStateCommand.class.getSimpleName();

    public GetDeviceStateCommand(HaotekDevice device, int CommandType) {
