 ...
 */
public class GetAudioRecodingStateCommand extends HaotekCommand {
    private static final String TAG = GetAudioRecodingStateCommand.class.getSimpleName();

    public GetAudioRecodingStateCommand(HaotekDevice device, int CommandType) {
