 ...
 */
public class SetVideoFequencyCommand extends HaotekCommand {
    private static final String TAG = SetVideoFequencyCommand.class.getSimpleName();
    private int mPar;

    public SetVideoFequencyCommand(HaotekDevice device, int CommandType, int par) {
...
//        return "?custom=1&cmd=2002&par="+mPar;
        return "?custom=1&cmd=" + WiFiCommandDefine.WIFIAPP_CMD_SET_FREQUENCY + "&par=" + mPar;
    }
