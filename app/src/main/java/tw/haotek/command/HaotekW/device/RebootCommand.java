 ...
 */
public class RebootCommand extends HaotekCommand {
    private static final String TAG = RebootCommand.class.getSimpleName();

    public RebootCommand(HaotekDevice device, int CommandType) {
...
//        return "?custom=1&cmd=3001";// 0:photo mode 1:movie mode 2:playback mode
        return "?custom=1&cmd=" + WiFiCommandDefine.WIFIAPP_CMD_SYSTEM_REBOOT;
    }
