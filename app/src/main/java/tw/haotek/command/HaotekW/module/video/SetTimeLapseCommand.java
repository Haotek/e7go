 ...
 */
public class SetTimeLapseCommand extends HaotekCommand {
    private static final String TAG = SetTimeLapseCommand.class.getSimpleName();
    private int mPar;

    public SetTimeLapseCommand(HaotekDevice device, int CommandType, int par) {
...
//        return "?custom=1&cmd=2019&par="+mPar;
        return "?custom=1&cmd=" + WiFiCommandDefine.MOVIE_REC_TIME_LAPSE + "&par=" + mPar;
    }
