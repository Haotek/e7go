 ...
 */
public class GetCardStatusCommand extends HaotekCommand {
    private static final String TAG = GetCardStatusCommand.class.getSimpleName();

    public GetCardStatusCommand(HaotekDevice device, int CommandType) {
        super(device, CommandType);
    }

    @Override
    protected String getAction() {
//        return "?custom=1&cmd=3024";
        return "?custom=1&cmd=" + WiFiCommandDefine.GET_CARD_STATUS;
    }
