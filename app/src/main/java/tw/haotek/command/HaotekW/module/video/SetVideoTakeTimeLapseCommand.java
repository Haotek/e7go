 ...
 */
public class SetVideoTakeTimeLapseCommand extends HaotekCommand {
    private static final String TAG = SetVideoTakeTimeLapseCommand.class.getSimpleName();

    public SetVideoTakeTimeLapseCommand(HaotekDevice device, int CommandType) {
        super(device, CommandType);
    }

    @Override
    protected String getAction() {
//        return "?custom=1&cmd=2019;
        return "?custom=1&cmd=" + WiFiCommandDefine.MOVIE_REC_TIME_LAPSE;
    }
                ...
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    switch (tagName) {
                        ...
                        case "Status":
                            ...
                            break;
                        case "NAME":
                            info.mFileName = xpp.nextText().replace("JPG", "");
                            list.add(info);
                            break;
                    }
                }
