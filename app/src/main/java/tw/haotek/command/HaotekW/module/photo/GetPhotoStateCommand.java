 ...
 */
public class GetPhotoStateCommand extends HaotekCommand {
    private static final String TAG = GetPhotoStateCommand.class.getSimpleName();

    public GetPhotoStateCommand(HaotekDevice device, int CommandType) {
