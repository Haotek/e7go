 ...
 */
public class GetGsensorStateCommand extends HaotekCommand {
    private static final String TAG = GetGsensorStateCommand.class.getSimpleName();

    public GetGsensorStateCommand(HaotekDevice device, int CommandType) {
