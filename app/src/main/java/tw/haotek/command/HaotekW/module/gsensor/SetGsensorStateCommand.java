package tw.haotek.command.HaotekW.module.gsensor;
 ...
 */
public class SetGsensorStateCommand extends HaotekCommand {
    private static final String TAG = SetGsensorStateCommand.class.getSimpleName();
    private int mPar;

    public SetGsensorStateCommand(HaotekDevice device, int CommandType, int par) {
...
//        return "?custom=1&cmd=2011&par="+mPar;
        return "?custom=1&cmd=" + WiFiCommandDefine.MOVIE_GSENSOR_SENS + "&par=" + mPar;
    }
