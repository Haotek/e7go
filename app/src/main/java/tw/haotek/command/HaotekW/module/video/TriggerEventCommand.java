 ...
 */
public class TriggerEventCommand extends HaotekCommand {
    private static final String TAG = TriggerEventCommand.class.getSimpleName();
    private int mPar;

    //    public TriggerEventCommand(HaotekDevice device, int CommandType, int par) {
    public TriggerEventCommand(HaotekDevice device, int CommandType, int par) {
...
//        return "?custom=1&cmd=9000&par="+mPar;
        return "?custom=1&cmd=" + WiFiCommandDefine.WIFIAPP_CMD_EVENT_SET + "&par=" + mPar;
    }
