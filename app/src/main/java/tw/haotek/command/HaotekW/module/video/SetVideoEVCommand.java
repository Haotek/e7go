 ...
 */
public class SetVideoEVCommand extends HaotekCommand {
    private static final String TAG = SetVideoEVCommand.class.getSimpleName();
    private int mPar;

    public SetVideoEVCommand(HaotekDevice device, int CommandType, int par) {
...
//        return "?custom=1&cmd=2005&par="+mPar;
        return "?custom=1&cmd=" + WiFiCommandDefine.MOVIE_EV + "&par=" + mPar;
    }
