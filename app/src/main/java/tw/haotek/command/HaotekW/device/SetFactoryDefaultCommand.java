 ...
 */
public class SetFactoryDefaultCommand extends HaotekCommand {
    private static final String TAG = SetFactoryDefaultCommand.class.getSimpleName();

    public SetFactoryDefaultCommand(HaotekDevice device, int CommandType) {
        super(device, CommandType);
    }

    @Override
    protected String getAction() {
        return "?custom=1&cmd=" + WiFiCommandDefine.SET_SYS_RESET;
    }
