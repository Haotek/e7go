 ...
 */
public class SetRFPairingCommand extends HaotekCommand {
    private static final String TAG = SetRFPairingCommand.class.getSimpleName();

    public SetRFPairingCommand(HaotekDevice device, int CommandType) {
        super(device, CommandType);
    }

    @Override
    protected String getAction() {
        return "?custom=1&cmd=" + WiFiCommandDefine.WIFIAPP_CMD_SET_RF_PAIR;
    }
