package tw.haotek.command.HaotekW.module.battery;
 ...
 */
public class GetBatteryLevelCommand extends HaotekCommand {
    private static final String TAG = GetBatteryLevelCommand.class.getSimpleName();

    public GetBatteryLevelCommand(HaotekDevice device, int CommandType) {
        super(device, CommandType);
    }

    @Override
    protected String getAction() {
//        return "?custom=1&cmd=3019";
        return "?custom=1&cmd=" + WiFiCommandDefine.GET_BATTERY_LEVEL;
    }
