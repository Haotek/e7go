package tw.haotek.command.HaotekW.module.audio;
 ...
 */
public class SetAudioRecordingStateCommand extends HaotekCommand {
    private static final String TAG = SetAudioRecordingStateCommand.class.getSimpleName();
    private int mPar;

    public SetAudioRecordingStateCommand(HaotekDevice device, int CommandType, int par) {
    ...
    protected String getAction() {
        Log.d(TAG, "Show Action : " + "?custom=1&cmd=" + WiFiCommandDefine.MOVIE_AUDIO + "&par=" + mPar);
        return "?custom=1&cmd=" + WiFiCommandDefine.MOVIE_AUDIO + "&par=" + mPar;
    }
