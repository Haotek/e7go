 ...
 */
public class SetPhotoTakePhotoCommand extends HaotekCommand {
    private static final String TAG = SetPhotoTakePhotoCommand.class.getSimpleName();

    public SetPhotoTakePhotoCommand(HaotekDevice device, int CommandType) {
        super(device, CommandType);
    }

    @Override
    protected String getAction() {
//        return "?custom=1&cmd=1001;
        return "?custom=1&cmd=" + WiFiCommandDefine.CAPTURE;
    }
