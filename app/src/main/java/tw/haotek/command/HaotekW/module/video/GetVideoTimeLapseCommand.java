 ...
 */
public class GetVideoTimeLapseCommand extends HaotekCommand {
    private static final String TAG = GetVideoTimeLapseCommand.class.getSimpleName();

    public GetVideoTimeLapseCommand(HaotekDevice device, int CommandType) {
        super(device, CommandType);
    }

    @Override
    protected String getAction() {
//        return "?custom=1&cmd=2021";
        return "?custom=1&cmd=" + WiFiCommandDefine.GET_TIME_LAPSE;
    }
