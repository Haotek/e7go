 ...
 */
public class SetCyclicRecordingCommand extends HaotekCommand {
    private static final String TAG = SetCyclicRecordingCommand.class.getSimpleName();
    private int mPar;

    public SetCyclicRecordingCommand(HaotekDevice device, int CommandType, int par) {
    ...
    protected String getAction() {
        return "?custom=1&cmd=" + WiFiCommandDefine.MOVIE_CYCLIC_REC + "&par=" + mPar;
    }
