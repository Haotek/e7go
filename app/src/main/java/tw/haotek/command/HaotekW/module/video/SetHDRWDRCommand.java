 ...
 */
public class SetHDRWDRCommand extends HaotekCommand {
    private static final String TAG = SetHDRWDRCommand.class.getSimpleName();
    private int mPar;

    public SetHDRWDRCommand(HaotekDevice device, int CommandType, int par) {
...
//        return "?custom=1&cmd=2004&par="+mPar;
        return "?custom=1&cmd=" + WiFiCommandDefine.MOVIE_HDR + "&par=" + mPar;
    }
