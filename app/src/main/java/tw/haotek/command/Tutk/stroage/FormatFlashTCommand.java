 ...
 */
public class FormatFlashTCommand extends TutkCommand {
    private static final String TAG = FormatFlashTCommand.class.getSimpleName();
    private int mPar;

    // 0: nand 1:SD
    public FormatFlashTCommand(HaotekDevice device, int par) {
        super(device);
        mPar = par;
    }
    ...
    protected int getActionID() {
        return WiFiCommandDefine.FORMAT;
    }
