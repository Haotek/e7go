 ...
 */
public class SetMotionDetectTCommand extends TutkCommand {
    private static final String TAG = SetMotionDetectTCommand.class.getSimpleName();
    private int mPar;

    public SetMotionDetectTCommand(HaotekDevice device, int par) {
        super(device);
        mPar = par;
    }
    ...
    protected int getActionID() {
        return WiFiCommandDefine.MOTION_DET;
    }
