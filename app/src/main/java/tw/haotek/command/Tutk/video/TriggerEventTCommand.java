 ...
 */
public class TriggerEventTCommand extends TutkCommand {
    private static final String TAG = TriggerEventTCommand.class.getSimpleName();
    private int mPar;

    public TriggerEventTCommand(HaotekDevice device, int par) {
        super(device);
        mPar = par;
    }
    ...
    protected int getActionID() {
        return WiFiCommandDefine.WIFIAPP_CMD_EVENT_SET;
    }
