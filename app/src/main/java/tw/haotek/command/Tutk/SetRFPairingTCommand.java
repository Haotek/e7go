 ...
 */
public class SetRFPairingTCommand extends TutkCommand {
    private static final String TAG = SetRFPairingTCommand.class.getSimpleName();

    public SetRFPairingTCommand(HaotekDevice device) {
        super(device);
    ...
    protected int getActionID() {
        return WiFiCommandDefine.WIFIAPP_CMD_SET_RF_PAIR;
    }
