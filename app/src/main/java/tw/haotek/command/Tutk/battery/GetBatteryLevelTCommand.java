package tw.haotek.command.Tutk.battery;
 ...
 */
public class GetBatteryLevelTCommand extends TutkCommand {
    private static final String TAG = GetBatteryLevelTCommand.class.getSimpleName();

    public GetBatteryLevelTCommand(HaotekDevice device) {
        super(device);
    }
    ...
    protected int getActionID() {
        return WiFiCommandDefine.GET_BATTERY_LEVEL;
    }
