package tw.haotek.command.Tutk.gsensor;
 ...
 */
public class SetGsensorStateTCommand extends TutkCommand {
    private static final String TAG = SetGsensorStateTCommand.class.getSimpleName();
    private int mPar;

    public SetGsensorStateTCommand(HaotekDevice device, int par) {
        super(device);
        mPar = par;
    }
    ...
    protected int getActionID() {
        return WiFiCommandDefine.MOVIE_GSENSOR_SENS;
    }
