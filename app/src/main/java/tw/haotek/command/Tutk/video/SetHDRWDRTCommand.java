 ...
 */
public class SetHDRWDRTCommand extends TutkCommand {
    private static final String TAG = SetHDRWDRTCommand.class.getSimpleName();
    private int mPar;

    public SetHDRWDRTCommand(HaotekDevice device, int par) {
        super(device);
        mPar = par;
    }
    ...
    protected int getActionID() {
        return WiFiCommandDefine.MOVIE_HDR;
    }
