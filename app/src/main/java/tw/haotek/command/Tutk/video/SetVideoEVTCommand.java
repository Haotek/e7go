 ...
 */
public class SetVideoEVTCommand extends TutkCommand {
    private static final String TAG = SetVideoEVTCommand.class.getSimpleName();
    private int mPar;

    public SetVideoEVTCommand(HaotekDevice device, int par) {
        super(device);
        mPar = par;
    }
    ...
    protected int getActionID() {
        return WiFiCommandDefine.MOVIE_EV;
    }
