 ...
 */
public class GetVideoStateTCommand extends TutkCommand {
    private static final String TAG = GetVideoStateTCommand.class.getSimpleName();

    public GetVideoStateTCommand(HaotekDevice device) {
        super(device);
    }
