 ...
 */
public class SetVideoResolutionTCommand extends TutkCommand {
    private static final String TAG = SetVideoResolutionTCommand.class.getSimpleName();
    private int mPar;

    public SetVideoResolutionTCommand(HaotekDevice device, int par) {
        super(device);
        mPar = par;
    }
    ...
    protected int getActionID() {
        return WiFiCommandDefine.MOVIE_REC_SIZE;
    }
