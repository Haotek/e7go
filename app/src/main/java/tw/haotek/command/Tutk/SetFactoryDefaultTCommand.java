 ...
 */
public class SetFactoryDefaultTCommand extends TutkCommand {
    private static final String TAG = SetFactoryDefaultTCommand.class.getSimpleName();

    public SetFactoryDefaultTCommand(HaotekDevice device) {
        super(device);
    }
    ...
    protected int getActionID() {
        return WiFiCommandDefine.SET_SYS_RESET;
    }
