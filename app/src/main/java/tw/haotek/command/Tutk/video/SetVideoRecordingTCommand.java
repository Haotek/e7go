 ...
 */
public class SetVideoRecordingTCommand extends TutkCommand {
    private static final String TAG = SetVideoRecordingTCommand.class.getSimpleName();
    private int mPar;

    public SetVideoRecordingTCommand(HaotekDevice device, int par) {
        super(device);
        mPar = par;
    }
