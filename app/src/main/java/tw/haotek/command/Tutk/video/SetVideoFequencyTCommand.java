 ...
 */
public class SetVideoFequencyTCommand extends TutkCommand {
    private static final String TAG = SetVideoFequencyTCommand.class.getSimpleName();
    private int mPar;

    public SetVideoFequencyTCommand(HaotekDevice device, int par) {
        super(device);
        mPar = par;
    }
    ...
    protected int getActionID() {
        return WiFiCommandDefine.WIFIAPP_CMD_SET_FREQUENCY;
    }
