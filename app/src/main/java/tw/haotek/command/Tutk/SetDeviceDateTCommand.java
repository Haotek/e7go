 ...
 */
public class SetDeviceDateTCommand extends TutkCommand {
    private static final String TAG = SetDeviceDateTCommand.class.getSimpleName();
    private String mDate;

    public SetDeviceDateTCommand(HaotekDevice device, String date) {
        super(device);
        mDate = date;
    }
    ...
    protected String getAction() {
        return "custom=1&cmd=" + getActionID() + "&str=" + mDate;
    }

    @Override
    protected int getActionID() {
        return WiFiCommandDefine.SET_DATE;
    }
