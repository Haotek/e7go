 ...
 */
public class GetGsensorStateTCommand extends TutkCommand {
    private static final String TAG = GetGsensorStateTCommand.class.getSimpleName();

    public GetGsensorStateTCommand(HaotekDevice device) {
        super(device);
    }
