 ...
 */
public class CheckVideoRecStateTCommand extends TutkCommand {
    private static final String TAG = CheckVideoRecStateTCommand.class.getSimpleName();

    public CheckVideoRecStateTCommand(HaotekDevice device) {
        super(device);
    }
    ...
    protected int getActionID() {
        return WiFiCommandDefine.WIFIAPP_CMD_GET_REC_STATUS;
    }
