 ...
 */
public class GetCardStatusTCommand extends TutkCommand {
    private static final String TAG = GetCardStatusTCommand.class.getSimpleName();

    public GetCardStatusTCommand(HaotekDevice device) {
        super(device);
    }
    ...
    protected int getActionID() {
        return WiFiCommandDefine.GET_CARD_STATUS;
    }
