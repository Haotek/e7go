 ...
 */
public class SetDeviceTimeTCommand extends TutkCommand {
    private static final String TAG = SetDeviceTimeTCommand.class.getSimpleName();
    private String mTime;

    public SetDeviceTimeTCommand(HaotekDevice device, String time) {
        super(device);
        mTime = time;
    }
    ...
    protected String getAction() {
        return "custom=1&cmd=" + getActionID() + "&str=" + mTime;
    }

    @Override
    protected int getActionID() {
        return WiFiCommandDefine.SET_TIME;
    }
