 ...
 */
public class GetEvenFilelistTCommand extends TutkCommand {
    private static final String TAG = GetEvenFilelistTCommand.class.getSimpleName();

    public GetEvenFilelistTCommand(HaotekDevice device) {
        super(device);
    }
    ...
    protected int getActionID() {
        return WiFiCommandDefine.WIFIAPP_CMD_EVENT_LIST;
    }
