 ...
 */
public class GetAudioRecodingStateTCommand extends TutkCommand {
    private static final String TAG = GetAudioRecodingStateTCommand.class.getSimpleName();

    public GetAudioRecodingStateTCommand(HaotekDevice device) {
        super(device);
    }
    ...
    protected int getActionID() {
        return WiFiCommandDefine.GET_CURRENT_STATE;
    }
