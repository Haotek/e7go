 ...
 */
public class SetVideoTimeLapseTCommand extends TutkCommand {
    private static final String TAG = SetVideoTimeLapseTCommand.class.getSimpleName();
    private int mPar;

    public SetVideoTimeLapseTCommand(HaotekDevice device, int par) {
        super(device);
        mPar = par;
    }
    ...
    protected int getActionID() {
        return WiFiCommandDefine.MOVIE_REC_TIME_LAPSE;
    }
